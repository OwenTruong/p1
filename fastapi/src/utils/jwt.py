...
def create_access_token(username: str, hashed_password: str) -> str:
  """Uses username and hashed password to create personal cryptographically signed JWT string."""
...
def decode_and_verify_token(token: str) -> dict:
  """Decode token payload and validates signatures and time claims"""
  try:
